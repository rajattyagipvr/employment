...
export class LocationDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('employmentApp.location.delete.question'));
...
export default class LocationComponentsPage {
  ...
  async deleteLocation() {
    ...
    expect(await locationDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/employmentApp.location.delete.question/);
