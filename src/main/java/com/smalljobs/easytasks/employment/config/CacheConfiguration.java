package com.smalljobs.easytasks.employment.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("employment");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("employment");
        ...
        config.getMapConfigs().put("com.smalljobs.easytasks.employment.domain.*", initializeDomainMapConfig(jHipsterProperties));
